...
namespace CoffeeeLover.Views
{
    public class OrderItemsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("OrderID,Price,Quantity")] OrderItems orderItems)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("OrderID,Price,Quantity")] OrderItems orderItems)
        {
